...
All cells are of equal size by default, but users may pass explicity `widths` and/or `heights` in any valid grid units,

```{r sizes}
grid.arrange(grobs=gs[1:3], ncol=2, widths = unit(1:2, "null"), 
