...
tt1 <- ttheme_default()
tt2 <- ttheme_minimal()
tt3 <- ttheme_minimal(core=list(bg.par = list(fill = blues9, col=NA)), 
                      colhead=list(fg.par=list(col="navyblue")))
grid.arrange(
...
tt1 <- ttheme_default()
tt2 <- ttheme_default(core=list(fg.par=list(hjust=1, x=0.9)),
                      rowhead=list(fg.par=list(hjust=1, x=0.95)))
tt3 <- ttheme_default(core=list(fg.par=list(hjust=0, x=0.1)),
                      rowhead=list(fg.par=list(hjust=0, x=0)))
grid.arrange(
